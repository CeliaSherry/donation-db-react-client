...
export class EditDonation extends Component {
  ...
  componentDidMount() {
    this.props.getDonation(this.props.match.params.donationId).then(response => {
      this.setState({
  ...
  handleSubmit = (e) => {
    ...
    updateDonation(this.props.match.params.donationId, donationAmount, donationDate, note).then(response => {
        ...
        <div>
          ...
          <div style={{display: "flex", justifyContent: "center"}}>
            {this.state.success && this.state.submitted ?
                <Alert isOpen={this.state.visible} style={{width: "48rem"}} variant='success'> Successful donation
                  update!</Alert>
                : !this.state.success && this.state.submitted ?
                    ...
                    <form onSubmit={this.handleSubmit}>
                      <Row>
                        <Col>
                          <label htmlFor="inputAmount">Amount</label>
                              <FormControl value={this.state.donationAmount || ''}
                      ...
                      {/* <FormGroup bsSize="large">
                        <label htmlFor="inputDate">Date</label>
                            <FormControl value={this.state.donationDate}
                      ...
                      <FormGroup bsSize="large">
                            <FormControl value={this.state.note}
...
export default connect(null, mapDispatchToProps)(EditDonation);