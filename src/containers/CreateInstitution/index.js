      ...
      <div >
        <div style={{ display: "flex", justifyContent: "center" }}>
          {this.state.success && this.state.submitted ?
            <Alert isOpen={this.state.visible} style={{ width: "48rem" }} variant='success'> Successful institute creation!</Alert>
...
export default connect(null, mapDispatchToProps)(CreateInstitution);