  ...
  return bindActionCreators(
    {
      ...
      getAllInstitutionsSortedAscendingName:
        actions.getAllInstitutionsSortedAscendingName,
      getAllInstitutionsSortedDescendingName:
        actions.getAllInstitutionsSortedDescendingName,
      getAllInstitutionsSortedAscendingState:
        actions.getAllInstitutionsSortedAscendingState,
      getAllInstitutionsSortedDescendingState:
        actions.getAllInstitutionsSortedDescendingState
    },
    dispatch
  );
}
      ...
      <div>
        ...
        <div style={{ display: "flex", justifyContent: "center" }}>
          {this.state.success && this.state.submitted ? (
            ...
            >
              {" "}
              Successful institution deletion
            </Alert>
          ) : !this.state.success && this.state.submitted ? (
          ...
          <tbody>
            {this.state.data.length > 0
              ? this.state.pageOfInstitution.map((institution, index) => (
                  <tr key={index}>
                    <td>
                      <Link to={`/institutions/${institution.id}/contacts`}>
                    ...
                    <td>
                      ...
                      <Button
                        ...
                        onClick={e =>
                          this.handleSubmit(e, institution.id, index)
                        }
                        variant="clear"
                      >
                        <FaTrash />
