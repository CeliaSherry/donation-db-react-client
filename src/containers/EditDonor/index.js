...
export class EditDonor extends Component {
  ...
  componentDidMount() {
    this.setState({ hideButtons: this.props.hideEditButtons });
      ...
      setTimeout(() => {
        ...
        if (this.state.success === true) {
          this.props.history.push(
            `/donor/${this.props.match.params.donorId}/details`
          );
          this.props.history.push({
            pathname: `/donor/${this.props.match.params.donorId}/details`,
            state: { donorName: this.state.name }
          });
        }
      }, 3000);
    });
  ...
  render() {
    const hideButton = this.props.hideEditButtons;
    return (
      <div>
        <div ref={this.myRef} />
        ...
        <div style={{ display: "flex", justifyContent: "center" }}>
          <Card style={{ width: "80rem" }}>
            <Card.Header as="h5">Donor Details
            ...
            <Card.Body>
              <div className="Edit Donor">
                    ...
                    <Col>
                      <FormGroup controlId="state" bssize="large">
                        ...
                        <FormControl
                          ...
                          onChange={e =>
                            this.setState({ addrState: e.target.value })
                          }
                          type="text"
                        />
                      </FormGroup>
                ...
                variant="dark"
                href={`/donor/${this.props.match.params.donorId}/details`}
                type="reset"
                hidden={hideButton}
              >
                Cancel
